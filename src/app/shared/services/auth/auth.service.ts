...
export class AuthService {
   ...
   private urlPasswordChange: string = environment.baseUrl + 'auth/password/change/'
   private urlPasswordReset: string = environment.baseUrl + 'auth/password/reset/'
   private urlTokenObtain: string = environment.baseUrl + 'auth/token/'
   private urlTokenRefresh: string = environment.baseUrl + 'auth/refresh/'
   private urlTokenVerify: string = environment.baseUrl + 'auth/token/verify/'
